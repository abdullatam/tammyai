      ...
      <div style={{ position: 'relative', background: 'linear-gradient(135deg, rgba(148, 125, 237, 0.12), rgba(148, 125, 237, 0.1))', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {mode === 'register' && <Input label="your name" placeholder="tamer" />}
            <Input label="email" placeholder="you@somewhere.com" />
            <Input label="password" type="password" placeholder="········" />
            <button className="btn btn-primary" onClick={onEnter} style={{ justifyContent: 'center', padding: '14px 22px', marginTop: 8 }}>
              {mode === 'login' ? 'come in' : 'begin'}
            </button>
            <button onClick={onEnter} style={{ background: 'none', border: 'none', color: 'var(--ink-3)', fontSize: 12, marginTop: 4, cursor: 'pointer' }}>
