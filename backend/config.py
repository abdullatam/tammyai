...
class Config:
    ...
    OPENAI_STARTING_BALANCE: float = float(os.getenv("OPENAI_STARTING_BALANCE", "3.07"))

    # ── Anthropic ────────────────────────────────────────
    ANTHROPIC_API_KEY: str = os.getenv("ANTHROPIC_API_KEY", "")
    TAMMY_ANTHROPIC_MODEL: str = os.getenv("TAMMY_ANTHROPIC_MODEL", "claude-sonnet-4-20250514")
    ANTHROPIC_STARTING_BALANCE: float = float(os.getenv("ANTHROPIC_STARTING_BALANCE", "3.29"))
